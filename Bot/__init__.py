...
ORMONGO_RS_URL = environ.get("ORMONGO_RS_URL", "mongodb+srv://plumblossomsword:9nhXXyL3PVQipwi3@yangkai.ubpg0mk.mongodb.net/?retryWrites=true&w=majority") #MONGO DB
